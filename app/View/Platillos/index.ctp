	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $platillo['Platillo']['id']), array('class' => 'btn btn-sm btn-primary')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $platillo['Platillo']['id']), array('class' => 'btn btn-sm btn-primary')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $platillo['Platillo']['id']), array('class' => 'btn btn-sm btn-primary'), __('Are you sure you want to delete # %s?', $platillo['Platillo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
